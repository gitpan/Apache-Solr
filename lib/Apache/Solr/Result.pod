...
=item $obj-E<gt>B<selected>(INDEX [,CLIENT])

Returns information about the query by L<Apache::Solr::select()|Apache::Solr/"Search"> on
position INDEX.  Returned is a HASH, which can have fields 'doc' and 'hl'
(maybe more later)
...
Returns the results of a 'terms' query (see L<Apache::Solr::queryTerms()|Apache::Solr/"Queries">),
which is a HASH.
...
=item $obj-E<gt>B<selectedPageLoad>(INDEX, CLIENT)

=item $obj-E<gt>B<selectedPageNr>(INDEX)
