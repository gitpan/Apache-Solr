...
See L<documentation in the base class|Apache::Solr/"DESCRIPTION">.
 
=head1 METHODS

See L<documentation in the base class|Apache::Solr/"METHODS">.
 
=head2 Constructors

See L<documentation in the base class|Apache::Solr/"Constructors">.
...
See L<documentation in the base class|Apache::Solr/"Accessors">.
...
See L<documentation in the base class|Apache::Solr/"Commands">.
 
=head2 Helpers

See L<documentation in the base class|Apache::Solr/"Helpers">.
...
See L<documentation in the base class|Apache::Solr/"DETAILS">.
